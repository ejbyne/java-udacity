...
public class CountryNames
{
    ...
    {
         if (name == "Etats-Unis" || name == "Pays-Bas")
         {
            return "les " + name;
         }
         else if ("Belize Cambodge Mexique Mozambique Zaire Zimbabwe".contains(name))
         {
            return "le " + name;
         }
         else if ("aeiou".contains(name.substring(0, 1).toLowerCase()))
         {
            return "l'" + name;
         }
