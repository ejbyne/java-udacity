...
public class TripPlan
{
    ...
    {
        String tripString = "TripPlan[";
        for (String city : trip)
        {
            tripString += city + ",";
        }
        return tripString.substring(0, tripString.length() -1) + "]";
    }
    ...
    public void reverse()
    {
        ArrayList<String> reverseTrip = new ArrayList<String>();
        for (int i = trip.size() - 1; i >= 0; i--)
        {
            reverseTrip.add(trip.get(i));
        }
        trip = reverseTrip;
    }
}