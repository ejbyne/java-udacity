public class Word
{
    ...
    */
    public String getPluralForm()
    {
        ...
        int penultimate = letters.length() - 2;
        if (is(last, "y") && isConsonant(penultimate))
        {
            return letters.substring(0, penultimate) + "ies";
        }
        else if (is(last, "o")
            || is(last, "s")
            || is(penultimate, "s") && is(last, "h")
            || is(penultimate, "c") && is(last, "h"))
        {
            return letters + "es";
        }
        else
