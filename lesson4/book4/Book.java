...
public class Book
{
    ...
    */
    ...
    {
        int startOfSecondSentence = bookText.indexOf(".") + 1;
        int endOfSecondSentence = bookText.indexOf(".", startOfSecondSentence);
        return bookText.substring(startOfSecondSentence, endOfSecondSentence + 1);
